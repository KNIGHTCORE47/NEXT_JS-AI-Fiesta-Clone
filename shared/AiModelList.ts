// Interface for individual sub-models
interface SubModel {
    name: string;
    premium: boolean;
    id: string;
...
// Interface for main AI model configuration
interface AIModel {
    model: string;
    icon: string;
    premium: boolean;
...
// Type for the entire models array
type AIModelsConfig = AIModel[];

// Example usage with the provided data
const aiModelsConfig: AIModelsConfig = [
    {
        model: "GPT",
        icon: "/gpt.png",
        premium: false,
